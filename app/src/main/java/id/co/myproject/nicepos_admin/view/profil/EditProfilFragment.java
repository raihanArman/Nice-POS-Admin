...
import id.co.myproject.nicepos_admin.util.ConvertBitmap;
...
//    }
    ...
    private void editProfile() {
        ...
        Call<Value> editUser = apiRequest.ediProfilAdminRequest(idAdmin, etUsername.getText().toString(),etNama.getText().toString(), etPassword.getText().toString() ,photoUser);
